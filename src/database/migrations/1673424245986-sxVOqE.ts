...
export class SxVOqE1673424245986 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` varchar(36) NOT NULL, \`nickname\` varchar(255) NULL COMMENT '姓名', \`username\` varchar(255) NOT NULL COMMENT '用户名', \`password\` varchar(500) NOT NULL COMMENT '密码', \`phone\` varchar(255) NULL COMMENT '手机号', \`email\` varchar(255) NULL COMMENT '邮箱', \`actived\` tinyint NOT NULL COMMENT '用户状态,是否激活' DEFAULT 1, \`isCreator\` tinyint NOT NULL COMMENT '是否是创始人' DEFAULT 0, \`createdAt\` datetime(6) NOT NULL COMMENT '用户创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '用户更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_fe0bb3f6520ee0469504521e71\` (\`username\`), UNIQUE INDEX \`IDX_a000cca60bcf04454e72769949\` (\`phone\`), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`storage_medias\` (\`id\` varchar(36) NOT NULL, \`file\` varchar(255) NOT NULL COMMENT '文件存储位置', \`ext\` varchar(255) NOT NULL COMMENT '文件后缀', \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, \`memberId\` varchar(36) NULL, \`carouselId\` varchar(36) NULL, \`thumbId\` varchar(36) NULL, \`backgroundId\` varchar(36) NULL, UNIQUE INDEX \`REL_37f59bfe6d7632baf5c6e272f1\` (\`carouselId\`), UNIQUE INDEX \`REL_2219af2c9f60371e402a327380\` (\`thumbId\`), UNIQUE INDEX \`REL_584d23a50a5e5cd87c9290d2f7\` (\`backgroundId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`content_cards\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL COMMENT '卡片标题', \`body\` longtext NOT NULL COMMENT '卡片内容', \`link\` varchar(255) NOT NULL COMMENT '卡片链接', \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`customOrder\` int NOT NULL COMMENT '全局文章排序' DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`content_categories\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL COMMENT '分类名称', \`customOrder\` int NOT NULL COMMENT '分类排序' DEFAULT '0', \`mpath\` varchar(255) NULL DEFAULT '', \`parentId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`content_posts\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL COMMENT '文章标题', \`body\` longtext NOT NULL COMMENT '文章内容', \`summary\` varchar(255) NULL COMMENT '文章描述', \`title_en\` varchar(255) NULL COMMENT '文章标题_英文', \`body_en\` longtext NULL COMMENT '文章内容_英文', \`summary_en\` varchar(255) NULL COMMENT '文章描述_英文', \`keywords\` text NULL COMMENT '关键字', \`createdAt\` datetime(6) NOT NULL COMMENT '创建时间' DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL COMMENT '更新时间' DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`publishedAt\` varchar(255) NULL COMMENT '发布时间', \`customOrder\` int NOT NULL COMMENT '全局文章排序' DEFAULT '0', \`authorId\` varchar(36) NOT NULL, \`thumbId\` varchar(36) NULL, \`backgroundId\` varchar(36) NULL, UNIQUE INDEX \`REL_c21b3084624e8d5606d679ad91\` (\`thumbId\`), UNIQUE INDEX \`REL_dcfef786659659e2c28e4350fd\` (\`backgroundId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`content_carousels\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NOT NULL COMMENT '图片标题', \`description\` longtext NOT NULL COMMENT '图片内容', \`link\` varchar(255) NOT NULL COMMENT '图片链接', \`customOrder\` int NOT NULL COMMENT '图片排序' DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`content_cards_posts_content_posts\` (\`contentCardsId\` varchar(36) NOT NULL, \`contentPostsId\` varchar(36) NOT NULL, INDEX \`IDX_6089b17563d0e4a28e31cf1a2a\` (\`contentCardsId\`), INDEX \`IDX_28e803c35df0c0cd389289bd9e\` (\`contentPostsId\`), PRIMARY KEY (\`contentCardsId\`, \`contentPostsId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`storage_medias\` ADD CONSTRAINT \`FK_37f59bfe6d7632baf5c6e272f11\` FOREIGN KEY (\`carouselId\`) REFERENCES \`content_carousels\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`storage_medias\` ADD CONSTRAINT \`FK_2219af2c9f60371e402a327380b\` FOREIGN KEY (\`thumbId\`) REFERENCES \`content_posts\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`storage_medias\` ADD CONSTRAINT \`FK_584d23a50a5e5cd87c9290d2f75\` FOREIGN KEY (\`backgroundId\`) REFERENCES \`content_posts\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`content_categories\` ADD CONSTRAINT \`FK_a03aea27707893300382b6f18ae\` FOREIGN KEY (\`parentId\`) REFERENCES \`content_categories\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`content_posts\` ADD CONSTRAINT \`FK_c21b3084624e8d5606d679ad916\` FOREIGN KEY (\`thumbId\`) REFERENCES \`storage_medias\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`content_posts\` ADD CONSTRAINT \`FK_dcfef786659659e2c28e4350fd6\` FOREIGN KEY (\`backgroundId\`) REFERENCES \`storage_medias\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`content_cards_posts_content_posts\` ADD CONSTRAINT \`FK_6089b17563d0e4a28e31cf1a2a6\` FOREIGN KEY (\`contentCardsId\`) REFERENCES \`content_cards\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`content_cards_posts_content_posts\` ADD CONSTRAINT \`FK_28e803c35df0c0cd389289bd9e3\` FOREIGN KEY (\`contentPostsId\`) REFERENCES \`content_posts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`content_cards_posts_content_posts\` DROP FOREIGN KEY \`FK_28e803c35df0c0cd389289bd9e3\``);
        await queryRunner.query(`ALTER TABLE \`content_cards_posts_content_posts\` DROP FOREIGN KEY \`FK_6089b17563d0e4a28e31cf1a2a6\``);
        ...
        await queryRunner.query(`ALTER TABLE \`content_posts\` DROP FOREIGN KEY \`FK_dcfef786659659e2c28e4350fd6\``);
        await queryRunner.query(`ALTER TABLE \`content_posts\` DROP FOREIGN KEY \`FK_c21b3084624e8d5606d679ad916\``);
        ...
        await queryRunner.query(`ALTER TABLE \`storage_medias\` DROP FOREIGN KEY \`FK_584d23a50a5e5cd87c9290d2f75\``);
        await queryRunner.query(`ALTER TABLE \`storage_medias\` DROP FOREIGN KEY \`FK_2219af2c9f60371e402a327380b\``);
        await queryRunner.query(`ALTER TABLE \`storage_medias\` DROP FOREIGN KEY \`FK_37f59bfe6d7632baf5c6e272f11\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_28e803c35df0c0cd389289bd9e\` ON \`content_cards_posts_content_posts\``);
        await queryRunner.query(`DROP INDEX \`IDX_6089b17563d0e4a28e31cf1a2a\` ON \`content_cards_posts_content_posts\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_dcfef786659659e2c28e4350fd\` ON \`content_posts\``);
        await queryRunner.query(`DROP INDEX \`REL_c21b3084624e8d5606d679ad91\` ON \`content_posts\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_584d23a50a5e5cd87c9290d2f7\` ON \`storage_medias\``);
        await queryRunner.query(`DROP INDEX \`REL_2219af2c9f60371e402a327380\` ON \`storage_medias\``);
        await queryRunner.query(`DROP INDEX \`REL_37f59bfe6d7632baf5c6e272f1\` ON \`storage_medias\``);
